...
const Signup = (props) => {
  ...
  const onSubmit = async (values) => {
    try {
      setIsLoading(true);
      const data = await services.signUp(values);
      if (data) {
        ...
        <div className="row justify-content-center p-md-5 p-2">
          <div className="col-md-5">
            <div className="text-center">
              <h4 className="text-black font-weight-bold">Welcome !!!</h4>
              <div className="text-black small">
                <div className="pb-2">Please sign up</div>
              </div>
            </div>
            ...
            <div className="d-flex justify-content-between text-off-black font-size-below">
              <span>
                Already on <strong>Twitee</strong>?{" "}
                <Link to="/login" className="font-weight-bolder">
                  Sign in
                </Link>
              </span>
              <Link
